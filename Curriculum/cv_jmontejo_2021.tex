...
One such example is the production of stop pairs with decays to higgsinos, featuring small splittings, and leading to a final state with soft leptons ($\pt \lesssim 5$ GeV) which is experimentally challenging.
...
\cvitem{}{
In addition, I am currently working on an analysis targeting models where the heavy Higgs sector can exhibit flavour-changing neutral currents. This kind of models feature a rich phenomenology, and can produce still unexplored signatures such as three-top production.
}
