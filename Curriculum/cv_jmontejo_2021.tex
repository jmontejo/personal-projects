...
I decided to concentrate on the associated production of a Higgs boson and a top quark pair (\ttH), given the important role of top Yukawa coupling which is the only ``natural'' Yukawa coupling, with $\lambda_\text{t}\approx 1$.
