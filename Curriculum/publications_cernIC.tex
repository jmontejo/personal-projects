...
Main analyser for the t\=tH(b\=b), VLQ and $\tilde{t}_2 \rightarrow \tilde{t}_1 H$ analyses. The latter is documented as part of the third-generation squarks summary paper.
}
