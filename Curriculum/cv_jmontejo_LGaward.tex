...
\cventry{\textbf{Trigger}}{}{}{}{
Trigger Menu in 2018 \coloredLink{https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PUBNOTES/ATL-DAQ-PUB-2019-001/}{ATL-DAQ-PUB-2019-001}\newline
...
\cventry{}{}{}{}{
\textbf{Studying the hierarchy problem, from the top yukawa coupling to top-partner searches}
}{}{}
\cventry{}{}{}{}{
The hierarchy problem can be defined as the fact that the difference between the weak scale and the Planck scale, MP /MW , is extremely large. This is not a fundamental problem of the SM itself, but it introduces a disturbing sensitivity of the Higgs potential to new physics in almost any imaginable extension of the SM. It also implies an extremely precise cancellation of the bare Higgs mass and the loop corrections in order to recover the observed Higgs mass at 125 GeV, also known as fine tuning. 
The largest correction to the Higgs boson mass comes from the top quark, since it is the heaviest particle in the SM. Several BSM models propose the introduction of top partners that cancel the corresponding corrections. }{}{}
\cventry{}{}{}{}{
I will review the current status of top yukawa coupling measurements and discuss searches for boson and fermionic top partners, with an emphasis on the latest ATLAS results on stop searches in RPC and RPV scenarios.}{}{}
\setlength{\hintscolumnwidth}{2.6cm}%{7.3cm} 
\setlength{\maincolumnwidth}{\textwidth-\leftskip-\rightskip-\separatorcolumnwidth-\hintscolumnwidth}
